/**
 * Editable copy for attribution and legal-adjacent disclaimers.
 * Kept in one file per CLAUDE.md rule #4 (Utah review pending — no
 * hardcoded legal claims scattered across pages).
 */
