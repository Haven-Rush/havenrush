...
export const EVENTS: SeedEvent[] = [
  ...
  {
    id: "evt-mueller-new-home-market",
    slug: "mueller-new-home-market",
    title: "Mueller New Home Market",
    type: "HOME_FAIR",
    neighborhood: "Mueller",
    city: "Austin",
    state: "TX",
    startsAt: "2026-12-05T10:00:00-06:00",
    endsAt: "2026-12-05T15:00:00-06:00",
    dateLabel: "Sat, Dec 5 · Mueller, Austin",
    description:
      "A builder-hosted market of move-in-ready and to-be-built homes across Mueller, with local coffee and food trucks. Walk the model homes at your own pace — no sales pitches required.",
    rewardTiers: [
      { stops: 3, reward: "Free coffee" },
      { stops: 5, reward: "Prize drawing entry" },
    ],
    sponsors: [
      { id: "spn-hill-country-mortgage", name: "Hill Country Mortgage", role: "Presenting sponsor" },
      { id: "spn-texas-title", name: "Texas Title Co.", role: "Category sponsor" },
    ],
    stops: [
      {
        id: "stop-mu-1",
        order: 1,
        kind: "LISTING",
        name: "Rowhouse — 2400 Zach Scott St",
        address: "2400 Zach Scott St, Austin, TX",
        brokerage: "Vantage Homes",
        agentName: "On-site sales team",
        scanToken: "mu1-a4jf80",
      },
      {
        id: "stop-mu-2",
        order: 2,
        kind: "LISTING",
        name: "3011 Aldrich St",
        address: "3011 Aldrich St, Austin, TX",
        brokerage: "Meritage Homes",
        agentName: "On-site sales team",
        scanToken: "mu2-e7ks35",
      },
      {
        id: "stop-mu-3",
        order: 3,
        kind: "LISTING",
        name: "2708 Barbara Jordan Blvd",
        address: "2708 Barbara Jordan Blvd, Austin, TX",
        brokerage: "David Weekley Homes",
        agentName: "On-site sales team",
        scanToken: "mu3-p1zx64",
      },
      {
        id: "stop-mu-4",
        order: 4,
        kind: "COFFEE",
        name: "Mueller Lake Park Coffee Cart",
        address: "1301 Simond Ave, Austin, TX",
        scanToken: "mu4-w9nc27",
      },
      {
        id: "stop-mu-5",
        order: 5,
        kind: "FOOD",
        name: "Mueller Farmers Market Food Trucks",
        address: "1905 Aldrich St, Austin, TX",
        scanToken: "mu5-b3hy18",
      },
    ],
  },
];
